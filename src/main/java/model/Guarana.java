...
public class Guarana {
    ...
    Guarana(UUID id, Integer version, String beerName, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
    ...
    public static GuaranaBuilder builder() {
        return new GuaranaBuilder();
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof Guarana)) return false;
        final Guarana other = (Guarana) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof Guarana;
    }
    ...
    public String toString() {
        return "Guarana(id=" + this.getId() + ", version=" + this.getVersion() + ", beerName=" + this.getBeerName() + ", upc=" + this.getUpc() + ", quantityOnHand=" + this.getQuantityOnHand() + ", price=" + this.getPrice() + ", createdDate=" + this.getCreatedDate() + ", updateDate=" + this.getUpdateDate() + ")";
    }

    public static class GuaranaBuilder {
        private UUID id;
        private Integer version;
        private String beerName;
        private String upc;
        ...
        public GuaranaBuilder id(UUID id) {
            this.id = id;
            return this;
        }

        public GuaranaBuilder version(Integer version) {
            this.version = version;
            return this;
        }

        public GuaranaBuilder beerName(String beerName) {
            this.beerName = beerName;
            return this;
        }

        public GuaranaBuilder upc(String upc) {
            this.upc = upc;
            return this;
        }

        public GuaranaBuilder quantityOnHand(Integer quantityOnHand) {
            this.quantityOnHand = quantityOnHand;
            return this;
        }

        public GuaranaBuilder price(BigDecimal price) {
            this.price = price;
            return this;
        }

        public GuaranaBuilder createdDate(LocalDateTime createdDate) {
            this.createdDate = createdDate;
            return this;
        }

        public GuaranaBuilder updateDate(LocalDateTime updateDate) {
            this.updateDate = updateDate;
            return this;
        }

        public Guarana build() {
            return new Guarana(this.id, this.version, this.beerName, this.upc, this.quantityOnHand, this.price, this.createdDate, this.updateDate);
        }

        public String toString() {
            return "Guarana.GuaranaBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}
